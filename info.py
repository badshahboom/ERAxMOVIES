...
API_ID = int(environ.get('API_ID', '20427388'))
API_HASH = environ.get('API_HASH', 'fc35fbeb5eecb4f4f9de49312468f518')
BOT_TOKEN = environ.get('BOT_TOKEN', '')
PORT = environ.get('PORT', '8082')

# Owners 
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7968389767 6891895305').split()]
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Empire_7860') # without @ or https://t.me/ 
USERNAME = environ.get('USERNAME', "THEHYPER_ACX") # ADMIN USERNAME

# Database Channel 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '').split()]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002790963142'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002790963142'))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002758140247'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002758140247')) 
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002758140247'))
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Susant')

# Other Channel's
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002266840124'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','0'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002758140247') 
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002790963142')) 

# Added Link Here Not Id 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+yy8FjoNsqrNjZjg9')
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/ERA_MOVIE_GROUP')
...
START_IMG = (environ.get('START_IMG', 'https://files.catbox.moe/vfq1po.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://files.catbox.moe/484g9w.jpg')).split()
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://files.catbox.moe/8j5ewa.jpg'))
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
