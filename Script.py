...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/SusantxBotz">˹Sᴜsᴀɴᴛ ꭙ Sᴜᴘᴘᴏʀᴛ˼</a></blockquote>"""
...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/SusantxBotz'>˹Sᴜsᴀɴᴛ ꭙ Sᴜᴘᴘᴏʀᴛ˼</a></b></blockquote>"""
    

    ABOUT_TEXT = """<blockquote><b>‣ ᴍʏ ɴᴀᴍᴇ : Susant filter bot
‣ ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/Empire_7860'>Bᴀᴅsʜᴀʜ Wᴀʀʀɪᴏʀ</a>
‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ
‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ
‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ
‣ ʜᴏsᴛᴇᴅ ᴏɴ  :  ᴡᴇʙ
...
If there is an error, ask in the support group @DragonByteGc</b>"""
...
3:- ᴄʀᴇᴀᴛᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ ᴀɴʏ sʜᴏʀᴛɴᴇʀ ʟɪᴋᴇ ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴜsᴇ ᴛʜɪs ʙᴇsᴛ sʜᴏʀᴛɴᴇʀ <a href=https://linkmonetizer.in/ref/susant>Best Shortner</a>.
...
🆔 Aᴅᴍɪɴ Iᴅ <code>@Empire_7860</code>
 
⛽️ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ: /myplan

🏷️ <a href='https://telegram.dog/ERA_MOVIES_HUB'>ᴘʀᴇᴍɪᴜᴍ ᴘʀᴏᴏꜰ</a>
